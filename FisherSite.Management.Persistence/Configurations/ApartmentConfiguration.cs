...
namespace FisherSite.Persistence.Configurations
{
    public class ApartmentConfiguration : IEntityTypeConfiguration<Apartment>
    {
        public void Configure(EntityTypeBuilder<Apartment> builder)
        {
            ...
            builder.HasData(
                new Apartment() { Id = 1, BlockId = 1, ApartmentStateId = 1, ApartmentTypeId = 1, ApartmentFloor = Floor.FifthFloor, PersonId = null },
                new Apartment() { Id = 2, BlockId = 1, ApartmentStateId = 1, ApartmentTypeId = 1, ApartmentFloor = Floor.FifthFloor, PersonId = null },
                new Apartment() { Id = 3, BlockId = 2, ApartmentStateId = 1, ApartmentTypeId = 1, ApartmentFloor = Floor.FifthFloor, PersonId = null },
